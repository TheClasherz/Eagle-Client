...
import Eagle.Client;
import Eagle.Hero.clickgui.elements.Element;
import Eagle.Hero.clickgui.elements.ModuleButton;
import Eagle.Hero.clickgui.elements.menu.ElementSlider;
import Eagle.Hero.clickgui.util.ColorUtil;
import Eagle.Hero.clickgui.util.FontUtil;
...
public class clickGUI extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		/* https://www.youtube.com/channel/UCJum3PIbnYvIfIEu05GL_yQ	*/ FontUtil.drawStringWithShadow(Client.version, -Minecraft.getMinecraft().fontRendererObj.getStringWidth(Client.version), -Minecraft.getMinecraft().fontRendererObj.FONT_HEIGHT, 0xff11F86B);
		/*															*/ GL11.glPopMatrix();
